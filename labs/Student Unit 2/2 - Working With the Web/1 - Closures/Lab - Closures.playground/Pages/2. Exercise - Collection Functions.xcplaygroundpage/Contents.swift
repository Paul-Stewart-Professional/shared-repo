...
var friendsAndFamily: [String] = ["George W Bush", "Selena Gomez", "Tim and Moby"]
var sortedCollection1 = friendsAndFamily.sorted(by: forwards(name1:name2:))
...
var backwards = { (name1: String, name2: String) -> Bool in
    return name1 > name2
}

print(friendsAndFamily.sorted(by: backwards))
...
let sortedCollection3 = friendsAndFamily.sorted { ($0 > $1) }
