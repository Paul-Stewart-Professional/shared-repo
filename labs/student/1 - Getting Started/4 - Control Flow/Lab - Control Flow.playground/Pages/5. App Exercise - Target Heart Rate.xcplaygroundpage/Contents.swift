...
let currentHR = 147
let isInTarget:Int = 134

if isInTarget < targetLowerBound {
    print("You're doing great, but try to push it a bit!")
}
else if isInTarget >= targetLowerBound && isInTarget <= targetUpperBound {
    print("You're right on track!")
}
else if isInTarget > targetUpperBound {
