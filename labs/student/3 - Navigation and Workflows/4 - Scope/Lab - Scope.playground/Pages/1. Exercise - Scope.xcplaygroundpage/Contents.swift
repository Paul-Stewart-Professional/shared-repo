...
//print("The value of foo is \(foo)")
//becayse \(foo) only exists within the for in loop
...
//because the var x exists outside of the for in loop. it is modified in the for in loop.
...
greeting(greeting: "Hello there, ", name: "Jessica")
greeting(greeting: nil, name: "Friend")
