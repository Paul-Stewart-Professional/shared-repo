...
//func checkAge() {
//    if Int(userInputAge) ?? -2 > 18 {
//        print("Welcome!")
//    } else if Int(userInputAge) ?? -2 == -2 {
//        print("Sorry, something went wrong. Can you please re-enter your age?")
//    }
//        else {
//        print("You are not old enough to use our app.")
//    }
//}

//func checkAge() {
//    if Int(userInputAge) != nil && Int(userInputAge)! > 18 {
//        print("welcome!")
//    } else if Int(userInputAge) != nil && Int(userInputAge)! < 18 {
//        print("You are not old enough to use our app")
//    } else {
...
//        if Int(userInputAge)! > 18 {
//            print("welcome!")
//        } else if Int(userInputAge)! < 18 {
//            print("You are not old enough to use our app")
//        }
//    } else {
//        print("Something went wrong...")
...
//it will not always return a value because it takes in a string, and if it cannot be converted it will return as nil.
...
func buyingFood(item: String) -> Double? {
    if Int(stock.values.count) <= 1  {
        return nil
    }
    print(Double(prices[item]!))
    return Double(prices[item]!)

}


buyingFood(item: "Chips")
/*:
