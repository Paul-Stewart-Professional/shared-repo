...
var statesAndCapitals: [String : String] = ["Utah" : "Salt Lake City", "Washington" : "Olympia", "California" : "Sacramento"]

for (state, capital) in statesAndCapitals {
    if state == "Utah" || capital == "Salt Lake City" {
        print("\(state) is my home state!")
        break
    } else {
