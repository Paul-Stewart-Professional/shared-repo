...
func progressUpdate(steps: Int, goal: Int) {
    ...
    } else if steps > goal / 2 && steps < goal * (9/10) {
        print("Youre over halfway there!")
    } else if steps > goal * (9/10) && steps < goal {
...
progressUpdate(steps: 650, goal: 500)
...
pace(currentDistance: 89, totalDistance: 100.0, currentTime: 9.0, goalTime: 10.0)
/*:
