 ...
 */
var runningChallenges: [String] = ["Chase your neightbor as long as you can or until they threaten to call the police", "Run around a local middle school and yell you have candy"]
var walkingChallenges: [String] = ["Walk from your bed to the fridge and treat yourself to some mustard", "Walk on your hands all day"]
...
var acceptedChallenges: [String] = ["Chase your neightbor as long as you can or until they threaten to call the police", "Walk from your bed to the fridge and treat yourself to some mustard"]
//:  Write an if statement that will use `isEmpty` to check if there is anything in the array. If there is not, print a statement asking the user to commit to a challenge. Add an else-if statement that will print "The challenge you have chosen is <INSERT CHOSEN CHALLENGE>" if the array count is exactly 1. Then add an else statement that will print "You have chosen multiple challenges."
if acceptedChallenges.isEmpty {
    print("Please accept a challenge for this week")
} else if acceptedChallenges.count == 1 {
    print("The challenge you have chosen is \(acceptedChallenges)")
} else {
