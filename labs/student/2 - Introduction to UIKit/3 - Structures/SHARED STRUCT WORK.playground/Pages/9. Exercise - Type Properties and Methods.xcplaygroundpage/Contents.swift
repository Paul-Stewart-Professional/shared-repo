...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser: String = "speedy"
    
    
   mutating func login(userName: String) {
       if userName.lowercased() == self.userName {
...
var myUser = User(userName: "speedy", email: "blahblahblah@gmail.com", age: 17)
print(myUser)
/*:
 ...
 */
print(myUser.login(userName: "nope"))
print(myUser.login(userName: "Speedy"))
/*:
