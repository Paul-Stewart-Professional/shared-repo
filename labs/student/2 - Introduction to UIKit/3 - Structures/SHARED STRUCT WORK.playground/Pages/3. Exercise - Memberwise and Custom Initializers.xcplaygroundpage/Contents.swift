...
let favoriteBook = Book(author: "Taro Gomi", title: "Everyone Poops", price: 10.84, pages: 37)
print("My favorite book is \(favoriteBook.title) by \(favoriteBook.author), it is \(favoriteBook.pages) pages long and costs $\(10.84)")
/*:
...
var laptop2 = Laptop(yearPurchased: 2018)
/*:
...
print(Height(heightInInches: 72))
